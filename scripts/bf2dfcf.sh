...
#
# Interact with bswck/skeleton (current version: https://github.com/bswck/skeleton/tree/bf2dfcf).
#
# This file was generated from bswck/skeleton@bf2dfcf.
# Instead of changing this particular file, you might want to alter the template:
# https://github.com/bswck/skeleton/tree/bf2dfcf/project/scripts/%7B%7Bsref%7D%7D.sh.jinja
#
# Usage:
#
...
# Automatically copied from https://github.com/bswck/skeleton/tree/bf2dfcf/handle-task-event.sh
setup_gh() {
...
ensure_gh_environment() {
    ...
    echo "$(jq -n '{"deployment_branch_policy": {"protected_branches": false,"custom_branch_policies": true}}' | gh api -H "Accept: application/vnd.github+json" -X PUT "/repos/bswck/project/environments/$1" --input -)" > /dev/null 2>&1 || return 1
}
